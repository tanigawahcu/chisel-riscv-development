...
```sh
git clone git@github.com:tanigawahcu/chisel-riscv-development.git
cd chisel-riscv-development
```
...
#### Commit your changes
```sh
git commit -m 'Starting chisel-riscv-development'
...
```sh
./mill chisel-riscv-development.test
```
